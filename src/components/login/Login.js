                    ...
                    <div className="card flex-shrink-0 w-full max-w-sm rounded-none shadow-2xl bg-yellow-400">
                        <form onSubmit={handleSubmit} className="card-body">
                            ...
                            <div className="form-control mt-6">
                                <button className="btn btn-outline border-white">Login</button>
                            </div>
                            <div className="form-control mt-6">
                            <button className="btn btn-outline w-full border-white" onClick={handleGoogleLogin}>Login with<FcGoogle className='ml-2 text-xl'/>oogle</button>
                            </div>
                            <div>
